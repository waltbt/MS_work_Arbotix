...
def print_menu():
    ...
    print("13: LED off")
    print("14: servo test")
    print("15: Some move test...?")


def cycle_testpoints(pos_cmd, sen_IR_cmd, sen_TOF_cmd, sen_color_cmd, grp_cmd, loop_rate, filename):
    global test_pt_list
    global button_data
    global sensor_TOF_reading
    global sensor_IR_reading
...
def train(pos_cmd, sen_IR_cmd, sen_TOF_cmd, sen_color_cmd, grp_cmd, loop_rate):
    ...
    #print(test_pt_list)
    cycle_testpoints(pos_cmd, sen_IR_cmd, sen_TOF_cmd, sen_color_cmd, grp_cmd, loop_rate, filename)
...
def main():
    ...
    while(1):
        ...
        if(int(input_string) == 1):
            print("Training...")
            train(position_command, sen_IR_command, sen_TOF_command, sen_color_command, gripper_command, loop_rate)

...
# size_of_data = 3
# # crit = 'geni'
# title_name = 'IR Accuracy of Prediction and the depth (DT)'
# save_file = 'ir_dt_comb_depth_value.png'
...
# size_of_data = 3
# # crit = 'gini'
# title_name = 'TOF Accuracy of Prediction and the depth (DT)'
# save_file = 'tof_dt_comb_depth_value.png'
...
# size_of_data = 5
# # crit = 'gini'
# title_name = 'IR Color Accuracy of Prediction and the depth (DT)'
# save_file = 'ir_color_dt_comb_depth_value.png'
...
size_of_data = 5
# crit = 'gini'
title_name = 'TOF Color Accuracy of Prediction and the depth (DT)'
save_file = 'tof_color_dt_comb_depth_value.png'
...
# size_of_data = 5
# # crit = 'gini'
# title_name = 'IR TOF Color Accuracy of Prediction and the depth (DT)'
# save_file = 'ir_tof_color_dt_comb_depth_value.png'
...
for a in ['entropy','gini']:
    ...
    for i in range(1,26):
        ...
        clf = tree.DecisionTreeClassifier(criterion=a,max_depth=i)
    ...
    plt.plot(neighbors, prec_good, label = 'Good Grip'+' - ' + a)
    plt.plot(neighbors, prec_bad, label = 'Bad Grip'+' - ' + a)

...
(cl:defmethod cl:initialize-instance :after ((m <IR_sensor_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IR_sensor_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name trainer-msg:<IR_sensor_data> is deprecated: use trainer-msg:IR_sensor_data instead.")))

(cl:ensure-generic-function 'sensor_reading-val :lambda-list '(m))
(cl:defmethod sensor_reading-val ((m <IR_sensor_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trainer-msg:sensor_reading-val is deprecated.  Use trainer-msg:sensor_reading instead.")
  (sensor_reading m))

...
(cl:defmethod cl:initialize-instance :after ((m <TOF_sensor_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TOF_sensor_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_control-msg:<TOF_sensor_data> is deprecated: use arm_control-msg:TOF_sensor_data instead.")))

(cl:ensure-generic-function 'range_reading-val :lambda-list '(m))
(cl:defmethod range_reading-val ((m <TOF_sensor_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control-msg:range_reading-val is deprecated.  Use arm_control-msg:range_reading instead.")
  (range_reading m))

(cl:ensure-generic-function 'lux_reading-val :lambda-list '(m))
(cl:defmethod lux_reading-val ((m <TOF_sensor_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control-msg:lux_reading-val is deprecated.  Use arm_control-msg:lux_reading instead.")
  (lux_reading m))

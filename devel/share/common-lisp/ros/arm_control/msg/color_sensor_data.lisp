...
(cl:defmethod cl:initialize-instance :after ((m <color_sensor_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'color_sensor_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_control-msg:<color_sensor_data> is deprecated: use arm_control-msg:color_sensor_data instead.")))

(cl:ensure-generic-function 'rgb_values-val :lambda-list '(m))
(cl:defmethod rgb_values-val ((m <color_sensor_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control-msg:rgb_values-val is deprecated.  Use arm_control-msg:rgb_values instead.")
  (rgb_values m))

(cl:ensure-generic-function 'color_temp-val :lambda-list '(m))
(cl:defmethod color_temp-val ((m <color_sensor_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control-msg:color_temp-val is deprecated.  Use arm_control-msg:color_temp instead.")
  (color_temp m))

(cl:ensure-generic-function 'lux-val :lambda-list '(m))
(cl:defmethod lux-val ((m <color_sensor_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_control-msg:lux-val is deprecated.  Use arm_control-msg:lux instead.")
  (lux m))
